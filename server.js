...
app.put("/api/crafts/:id", upload.single("image_input"), (request, response) =>
{
    ...
    editCraft.supplies = request.body.supply_input.split(","); // Splits comma-separated items in array 
